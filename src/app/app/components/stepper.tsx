...
const steps = [
  {
    ...
    illustration: <Image src={depositChart} alt="Deposit chart" width={44} height={44} className="object-contain" />,
  },
  {
    id: 1,
    label: 'Get xBTC',
    description: 'Instantly get liquid tokens representing your staked Bitcoin.',
    illustration: <Image src={xbtcIcons} alt="xBTC tokens" width={44} height={44} className="object-contain" />,
  },
  {
    id: 2,
    label: 'Use in DeFi',
    description: 'Maximize your yield by using your tokens in the DeFi ecosystem.',
    illustration: <Image src={defiIcons} alt="Defi logos" width={44} height={44} className="object-contain" />,
  },
];
  ...
  return (
    <div className="w-full px-4 md:px-0">
      ...
      <div className="hidden md:block relative z-10">
        ...
        {/* Content Card */}
        <div
          className={`absolute -bottom-[100px] transition-all duration-300 ease-in-out ${active == 2 ? 'left-[80%]! md:left-[85%]!' : ''}`}
          style={{
            left: `calc((100% - 64px) / 2 * ${active} + 122px)`,
            transform: 'translateX(-50%)',
          }}
        >
            <div className="rounded-2xl"></div>
            <div className={`absolute -top-16 rounded-xl left-0 w-18 h-20 bg-white flex items-center justify-center ${active == 2 ? 'left-[183px]' : ''}` }>
          ...
          <div className="w-64 bg-white rounded-xl shadow-lg p-4">
            ...
            <p className="text-sm text-gray-600">{steps[active].description}</p>
          </div>
        </div>
      </div>
